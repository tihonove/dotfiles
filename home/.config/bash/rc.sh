...
# маркированный блок с source этого файла. Подробности — в README, раздел
# «Почему ~/.bashrc не симлинк».
#
# Следствие, важное для порядка загрузки: всё, что дописано в ~/.bashrc,
# выполняется ПОСЛЕ этого файла целиком, включая ble-attach внизу.
...
# Подцепить ble.sh — обязательно последней строкой этого файла, после starship.
